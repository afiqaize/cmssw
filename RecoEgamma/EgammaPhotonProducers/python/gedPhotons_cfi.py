...
gedPhotons = cms.EDProducer("GEDPhotonProducer",
    ...
    recHitEThresholdHB = cms.vdouble( 0., 0., 0., 0. ), # FIXME afiqaize add some noise cutoff to the rechits?
    recHitEThresholdHE = cms.vdouble( 0., 0., 0., 0., 0., 0., 0. ), # FIXME afiqaize add some noise cutoff to the rechits?
