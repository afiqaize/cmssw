...
GsfElectronAlgo::EventData GsfElectronAlgo::beginEvent(edm::Event const& event,
  ...
  EventData eventData{
      ...
      .hadIsolation03 =
      EgammaHcalIsolation(egHcalIsoConeSizeOutSmall, egHcalIsoConeSizeIn,
                          std::array<double, 4>{{0., 0., 0., 0.}},
                          std::array<double, 4>{{egHcalIsoPtMin, egHcalIsoPtMin, egHcalIsoPtMin, egHcalIsoPtMin}},
                          ...
                          caloGeometry, hcalRecHits),
      .hadIsolation04 =
      EgammaHcalIsolation(egHcalIsoConeSizeOutLarge, egHcalIsoConeSizeIn,
                          std::array<double, 4>{{0., 0., 0., 0.}},
                          std::array<double, 4>{{egHcalIsoPtMin, egHcalIsoPtMin, egHcalIsoPtMin, egHcalIsoPtMin}},
                          std::array<double, 7>{{0., 0., 0., 0., 0., 0., 0.}},
                          std::array<double, 7>{{egHcalIsoPtMin, egHcalIsoPtMin, egHcalIsoPtMin, egHcalIsoPtMin,
                          ...
                          caloGeometry, hcalRecHits),
      .hadIsolation03Bc =
      EgammaHcalIsolation(egHcalIsoConeSizeOutSmall, 0.087,
                          std::array<double, 4>{{0., 0., 0., 0.}},
                          std::array<double, 4>{{egHcalIsoPtMin, egHcalIsoPtMin, egHcalIsoPtMin, egHcalIsoPtMin}},
                          std::array<double, 7>{{0., 0., 0., 0., 0., 0., 0.}},
                          std::array<double, 7>{{egHcalIsoPtMin, egHcalIsoPtMin, egHcalIsoPtMin, egHcalIsoPtMin,
                          ...
                          caloGeometry, hcalRecHits),
      .hadIsolation04Bc =
      EgammaHcalIsolation(egHcalIsoConeSizeOutLarge, 0.087,
                          std::array<double, 4>{{0., 0., 0., 0.}},
                          std::array<double, 4>{{egHcalIsoPtMin, egHcalIsoPtMin, egHcalIsoPtMin, egHcalIsoPtMin}},
                          std::array<double, 7>{{0., 0., 0., 0., 0., 0., 0.}},
                          std::array<double, 7>{{egHcalIsoPtMin, egHcalIsoPtMin, egHcalIsoPtMin, egHcalIsoPtMin,
...
void GsfElectronAlgo::createElectron(reco::GsfElectronCollection& electrons,
  ...
  if (!EcalTools::isHGCalDet((DetId::Detector)region)) {
    for (int id = 0; id < 7; ++id) {
      ...
      dr03.hcalRecHitSumEtBc[id] = eventData.hadIsolation03Bc.getHcalEtSum(&ele, id);

      dr04.hcalRecHitSumEt[id]   = eventData.hadIsolation04.getHcalEtSum(&ele, id);
      dr04.hcalRecHitSumEtBc[id] = eventData.hadIsolation04Bc.getHcalEtSum(&ele, id);
    }
