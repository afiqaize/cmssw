...
void GsfElectronFakeAnalyzer::analyze(const edm::Event &iEvent, const edm::EventSetup &iSetup) {
  ...
  for (reco::CaloJetCollection::const_iterator moIter = recoCaloJets->begin(); moIter != recoCaloJets->end();
    ...
    if (okGsfFound) {
      ...
      h_ele_hcalDepth1RecHitSumEt_dr03->Fill(bestGsfElectron.dr03HcalRecHitSumEt(1));
      h_ele_hcalDepth2RecHitSumEt_dr03->Fill(bestGsfElectron.dr03HcalRecHitSumEt(2));
      h_ele_tkSumPt_dr04->Fill(bestGsfElectron.dr04TkSumPt());
      h_ele_ecalRecHitSumEt_dr04->Fill(bestGsfElectron.dr04EcalRecHitSumEt());
      h_ele_hcalDepth1RecHitSumEt_dr04->Fill(bestGsfElectron.dr04HcalRecHitSumEt(1));
      h_ele_hcalDepth2RecHitSumEt_dr04->Fill(bestGsfElectron.dr04HcalRecHitSumEt(2));
