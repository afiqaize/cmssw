...
PhotonIDProd = cms.EDProducer("PhotonIDProducer",
    ...
    LooseEMHcalRecHitIsoSlopeEB= cms.double(0.0025),
    LooseEMHcalRecHitIsoOffsetEB=cms.double(2.2),
    ...
    LoosePhotonHcalRecHitIsoSlopeEB= cms.double(0.0025),
    LoosePhotonHcalRecHitIsoOffsetEB=cms.double(2.2),
    ...
    TightPhotonHcalRecHitIsoSlopeEB= cms.double(0.0025),
    TightPhotonHcalRecHitIsoOffsetEB=cms.double(2.2),
    ...
    LooseEMHcalRecHitIsoSlopeEE= cms.double(0.0025),
    LooseEMHcalRecHitIsoOffsetEE=cms.double(2.2),
    ...
    LoosePhotonHcalRecHitIsoSlopeEE= cms.double(0.0025),
    LoosePhotonHcalRecHitIsoOffsetEE=cms.double(2.2),
    ...
    TightPhotonHcalRecHitIsoSlopeEE= cms.double(0.0025),
    TightPhotonHcalRecHitIsoOffsetEE=cms.double(2.2),
