...
cut = cms.string(
    ...
    ")"
    " || (isEE"
    " && ( dr03TkSumPt/p4.Pt <0.07 && dr03EcalRecHitSumEt/p4.Pt < 0.07 && dr03HcalRecHitSumEt/p4.Pt  < 0.07 )"
    " && (sigmaIetaIeta<0.03)"
...
cut = cms.string(
    ...
    " && (ecalEnergy*sin(superClusterPosition.theta)>" + str(ELECTRON_ET_CUT_MIN) + ")"
    " && ((isEB"
    " && ( dr03TkSumPt/p4.Pt <0.12 && dr03EcalRecHitSumEt/p4.Pt < 0.09 && dr03HcalRecHitSumEt/p4.Pt  < 0.1 )" #wrt std WP80 relaxing iso cuts to WP90 
    " && (sigmaIetaIeta<0.01)"
