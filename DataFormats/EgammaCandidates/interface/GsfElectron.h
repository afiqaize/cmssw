 ...
 ****************************************************************************/
  ...
  public:
    ...
    float dr03HcalRecHitSumEt(int depth = 0) const {
    ...
    float dr03HcalRecHitSumEtBc(int depth = 0) const {
    ...
    float dr04HcalRecHitSumEt(int depth = 0) const {
      const auto &hcaliso = dr04_.hcalRecHitSumEt;
      return (!(depth > 0 and depth < 8)) ? std::accumulate(std::begin(hcaliso), std::end(hcaliso), 0.f) : hcaliso[depth - 1];
    }
    float dr04HcalRecHitSumEtBc(int depth = 0) const {
